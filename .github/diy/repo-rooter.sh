...
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_aarch64_cortex-a53 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P aarch64_cortex-a53/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_aarch64_cortex-a72 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P aarch64_cortex-a72/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_x86_64 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P x86_64/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_mipsel_24kc | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P mipsel_24kc/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_mips_24kc | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P mips_24kc/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_i386_pentium4 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P i386_pentium4/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_xscale | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_xscale/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a15_neon-vfpv4 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a15_neon-vfpv4/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a9 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a9/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a9_vfpv3-d16 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a9_vfpv3-d16/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a7 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a7/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a7_neon-vfpv4 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a7_neon-vfpv4/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_cortex-a5_vfpv4 | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_cortex-a5_vfpv4/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_arm_arm1176jzf-s_vfp | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P arm_arm1176jzf-s_vfp/
curl -s https://api.github.com/repos/kzer00/packages-compile/releases/tags/"$NOW"_aarch64_generic | grep "browser_download_url.*" | cut -d : -f 2,3 | tr -d \" | wget -qi - -P aarch64_generic/
